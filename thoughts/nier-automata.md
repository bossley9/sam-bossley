...
Similarly, I think the content of the dialogue fits perfectly with the character's personalities. 2B never talks much and most of her dialogue is criticism/cynicism. 9S, on the other hand, enjoys talking (all too much), and [makes annoying snarky comments on everything](https://youtu.be/cr0Wu6qAVgs). A2 has an [annoyed but sassy attitude](https://youtu.be/uToO7lvuBJk), and she even has a [taunt ability to complement her personality](https://youtu.be/b2w9bkCpqbA).
...
_Why is it that the robots still have not found the resistance camp?_<br />
...
If the original lineup of tracks wasn't enough, the second playthrough introduces an [8-bit version of each track with hacking](https://www.youtube.com/watch?v=9S3k4jj5EdM&list=PLGDex3pfJA0hg8UInzxFUZvldPhWu8aXm) which fit the nature of hacking wonderfully - and the two flow together seamlessly.
...
To make matters even more interesting, the loading screen in between areas and cutscenes [represents the boot process](https://youtu.be/2wOipGPAUUM?t=66) of an operating system - albeit not entirely reflective of a [_real_ operating system](https://youtu.be/lizdpoZj_vU?t=227) (I feel the need to point this out as I regularly work with syslog screens and bootloaders such as [GRUB](https://en.wikipedia.org/wiki/GNU_GRUB)), but the bootloader sequence is a nice feature nonetheless.

In addition to being aesthetically pleasing, the design direction of the game even translates well into game mechanics. I've already mentioned the system regarding the plug-in chips. They also disable menu functionality and increase user interface minimalism when low on health - the player's screen will be reduced in color and the menu interfaces and HUD will be reduced to glitches using [channel cross contamination and layer clipping effects](https://youtu.be/zjr3zw2Dw9A?t=299). They even clipped the sounds - yes, _the sounds_ - to add to the experience. This minor detail adds a nice touch to the game and really emphasizes the damage the character receives.

The designs of the user interfaces similarly match with the hacking game design. In any hacking instance or ["system booting"](https://youtu.be/nbuTbm1ZpFM?t=1080) instance, the same colors and theming are consistently used to present a full-circle picture of the inner workings of an android.
